...
<div class="content-wrapper">
    ...
    <div class="table-agile-info">
        ...
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <h3 style="color: rgb(255, 255, 255)">THÔNG TIN ĐĂNG NHẬP</h3>
            </div>
    ...
    <div class="table-agile-info">
        ...
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <h3 style="color: rgb(255, 255, 255)">THÔNG TIN ĐƠN HÀNG</h3>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
                ...
                {{-- <a target="_blank" href="{{ url('/print-order/' . $details->order_code) }}">In đơn hàng</a> --}}
                    ...
                    ?>
                        <!--login form-->
                        <h5>Gửi mail đặt hàng thành công</h5>
                        <form action="{{ URL::to('/send-mail') }}" method="GET">
                            {{ csrf_field() }}
                            <input type="text" name="email_account" value="{{ $shipping->shipping_email }}"
                                style="background-color:rgba(131, 160, 163, 0.781) ;margin-top:20;margin-left:50px;color:rgb(0, 0, 0);width: 350px;"
