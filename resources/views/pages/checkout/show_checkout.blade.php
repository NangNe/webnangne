...
@section('content')
    ...
    <section id="cart_items">
            ...
            <div class="shopper-informations">
                <div class="row">
                    ...
                    <div class="col-sm-12 clearfix">
                        ...
                        <div class="bill-to col-sm-6" style="margin-left: 30px">
                            <form>
                                @csrf
                                ...
                                <input style="margin-left: 400px" type="button" value="Tính phí vận chuyển"
                                    name="calculate_order" class="btn btn-primary btn-sm calculate_delivery">
        ...
        <div class="review-payment">
            <h2><a href="{{ URL::to('/gio-hang/') }}" style="color: red" ;> Quay lại giỏ hàng</a></h2>
        </div>
    </section>
    <!--/#cart_items-->
