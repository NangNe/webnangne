        ...
        <div class="row">
            ...
            <section class="panel">
                <header class="panel-heading text-center">
                    <h3 style="color: rgb(255, 255, 255)">THÊM NHÓM SẢN PHẨM</h3>
                </header>
                <?php
                ...
                <div class="panel-body"style="margin-left: 20%;margin-right: 20%">
                    <div class="position-center">
                        <form role="form" action="{{ URL::to('/save-brand-product') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Mô tả Nhóm</label>
                            ...
                            <button type="submit" name="add_category_product" class="btn btn-info">Thêm Nhóm</button>
                        </form>
                    </div>
